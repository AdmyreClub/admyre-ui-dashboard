                  ...
                  <div className="flex  gap-3 justify-center mt-4">
                    ...
                    >
                      ...
                      <p className="mt-2 text-[12px]">
                        Influencers keep the products in-exchange for posting
                        content. Brand can create multiple hampers for
                        influencers to choose. This type is most popular.
                      </p>
                    ...
                    >
                      ...
                      <p className="mt-2 text-[12px]">
                        Influencers get paid for posting content. No physical
                        product is delivered. Payout campaigns run faster and
                        experience higher interest from influencers.
                      </p>
                      <p className="mt-2 text-[12px]">Steps</p>
                      <li className="text-[12px]">
                    ...
                    >
                      ...
                      <p className="mt-2 text-[12px]">
                        Influencers order product they prefer from specified
                        website. Influencers are re-imbursed later. Such
                        campaigns experience low interest from influencers.
                      </p>
                      <p className="mt-2 text-[12px]">Steps</p>
                      <li className="text-[12px]">
                      ...
                      <li className="text-[12px]">
                        Influencers order specified products and share order
                        details
                      </li>
                      <li className="text-[12px]">
                        Influencers create and post content
                ...
                <>
                  <div className="flex flex-col">
                    <p className="text-[16px] font-semibold mt-4">
                      Enter the highlights of your campaign to get started with
                      the campaign setup.
                    </p>
                    <p className="text-slate-400 text-[12px]">
                      The information below will be displayed to the influencers
                      on the App.
                    </p>
